    ...
    >
        ...
        <Teleport to="body">
            <Transition @enter="onEnter" @leave="onLeave">
                <div
                    v-if="showTooltip"
                    class="absolute z-50 max-w-[350px] break-words rounded bg-white p-1.5 text-[.6rem] font-semibold text-slate-500 shadow-[inset_0_-4px_0_0_rgba(0,0,0,0.16)] dark:bg-dark-700 dark:text-white dark:shadow-[inset_0_-4px_0_0_rgba(15,18,26,0.3)]"
                >
                    <span
                        ref="arrowEl"
