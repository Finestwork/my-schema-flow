    ...
    >
        ...
        <Teleport to="body">
            <Transition @enter="onEnter" @leave="onLeave">
                <div
                    v-if="showTooltip"
                    class="absolute z-50 max-w-[350px] break-words rounded bg-slate-600 p-1.5 text-[.6rem] font-semibold text-slate-50 dark:bg-dark-700 dark:text-white"
                    :class="{
                ...
                >
                    <span
                        ref="arrowEl"
                        class="absolute block border-[.3rem] border-transparent border-b-slate-600 dark:border-b-dark-700"
                    ></span>
